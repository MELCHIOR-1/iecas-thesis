...
\newpage
对于多个连续的公式，如果使用连续的equation环境，中间会有很大的空隙，如使用下面命令：
\begin{verbatim}
\begin{equation}
	a+b=c
\end{equation}
...
\begin{figure}[!htbp]
    \centering
     \bicaption{激波圆柱作用，激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用激波圆柱作用。}{Shock-cylinder interaction.}
